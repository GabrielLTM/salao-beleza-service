...
export const openapiSpec = {
  ...
  components: {
    ...
    schemas: {
      ...
      FuncionarioCadastro: {
        type: 'object',
        required: ['nomeCompleto', 'profissaoCargo', 'email', 'senha', 'nivelPermissao', 'status'],
        properties: {
          nomeCompleto: { type: 'string', minLength: 2 },
          endereco: { type: 'string', nullable: true },
          telefone: { type: 'string', nullable: true },
          profissaoCargo: { type: 'string', minLength: 2 },
          email: { type: 'string', format: 'email' },
      ...
      AgendamentoCadastro: {
        type: 'object',
        required: ['clienteId', 'funcionarioId', 'servicoId', 'dataHoraInicio'],
        properties: {
          clienteId: { type: 'string', format: 'uuid' },
          funcionarioId: { type: 'string', format: 'uuid' },
          servicoId: { type: 'string', format: 'uuid' },
